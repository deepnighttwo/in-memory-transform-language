...
public interface ITLListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code MapFuncVar}
	 * labeled alternative in {@link ITLParser#propVar}.
	 * @param ctx the parse tree
	 */
	void enterMapFuncVar(@NotNull ITLParser.MapFuncVarContext ctx);
	/**
	 * Exit a parse tree produced by the {@code MapFuncVar}
	 * labeled alternative in {@link ITLParser#propVar}.
	 * @param ctx the parse tree
	 */
	void exitMapFuncVar(@NotNull ITLParser.MapFuncVarContext ctx);
	/**
	 * Enter a parse tree produced by the {@code ReduceFuncVar}
	 * labeled alternative in {@link ITLParser#propVar}.
	 * @param ctx the parse tree
	 */
	void enterReduceFuncVar(@NotNull ITLParser.ReduceFuncVarContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ReduceFuncVar}
	 * labeled alternative in {@link ITLParser#propVar}.
	 * @param ctx the parse tree
	 */
	void exitReduceFuncVar(@NotNull ITLParser.ReduceFuncVarContext ctx);
	/**
